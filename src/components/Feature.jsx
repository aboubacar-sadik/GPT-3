...
export default function Feature() {
	return (
		<section className="overflow-hidden relative pt-24 lg:pt-40 ">
			<div className="container flex items-start justify-between flex-wrap gap-16 ">
				...
				<div className="grid grid-cols-1 lg:w-3/5 gap-8 lg:gap-12">
					<Subtitle
